    ...
    clutch.amiibi = (function() {
        ...
        amiibi.v1 = (function() {
            ...
            v1.AmiiboAPI = (function() {
                ...
                /**
                 * Callback as used by {@link clutch.amiibi.v1.AmiiboAPI#getAmiibo}.
                 * @memberof clutch.amiibi.v1.AmiiboAPI
                 * @typedef GetAmiiboCallback
                 * @type {function}
                 * @param {Error|null} error Error, if any
                 * @param {clutch.amiibi.v1.GetAmiiboResponse} [response] GetAmiiboResponse
                 */
                 ...
                 * @memberof clutch.amiibi.v1.AmiiboAPI
                 * @instance
                 * @param {clutch.amiibi.v1.IGetAmiiboRequest} request GetAmiiboRequest message or plain object
                 * @param {clutch.amiibi.v1.AmiiboAPI.GetAmiiboCallback} callback Node-style callback called with the error, if any, and GetAmiiboResponse
                 * @returns {undefined}
                 * @variation 1
                 */
                Object.defineProperty(AmiiboAPI.prototype.getAmiibo = function getAmiibo(request, callback) {
                    return this.rpcCall(getAmiibo, $root.clutch.amiibi.v1.GetAmiiboRequest, $root.clutch.amiibi.v1.GetAmiiboResponse, request, callback);
                 ...
                 * @instance
                 * @param {clutch.amiibi.v1.IGetAmiiboRequest} request GetAmiiboRequest message or plain object
                 * @returns {Promise<clutch.amiibi.v1.GetAmiiboResponse>} Promise
                 * @variation 2
                 */
            ...
            v1.GetAmiiboRequest = (function() {
                 ...
                 * @constructor
                 * @param {clutch.amiibi.v1.IGetAmiiboRequest=} [properties] Properties to set
                 */
                 ...
                 * @member {string} name
                 * @memberof clutch.amiibi.v1.GetAmiiboRequest
                 * @instance
                 */
                 ...
                 * @returns {clutch.amiibi.v1.GetAmiiboRequest} GetAmiiboRequest
                 */
                GetAmiiboRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.clutch.amiibi.v1.GetAmiiboRequest)
                        return object;
                    let message = new $root.clutch.amiibi.v1.GetAmiiboRequest();
                    if (object.name != null)
                 ...
                 * @memberof clutch.amiibi.v1.GetAmiiboRequest
                 * @static
                 * @param {clutch.amiibi.v1.GetAmiiboRequest} message GetAmiiboRequest
            ...
            v1.GetAmiiboResponse = (function() {
                 ...
                 * @property {Array.<clutch.amiibi.v1.IAmiibo>|null} [amiibo] GetAmiiboResponse amiibo
                 */
                 ...
                 * @constructor
                 * @param {clutch.amiibi.v1.IGetAmiiboResponse=} [properties] Properties to set
                 */
                 ...
                 * @member {Array.<clutch.amiibi.v1.IAmiibo>} amiibo
                 * @memberof clutch.amiibi.v1.GetAmiiboResponse
                 * @instance
                 */
                ...
                GetAmiiboResponse.verify = function verify(message) {
                    ...
                    if (message.amiibo != null && message.hasOwnProperty("amiibo")) {
                        ...
                        for (let i = 0; i < message.amiibo.length; ++i) {
                            let error = $root.clutch.amiibi.v1.Amiibo.verify(message.amiibo[i]);
                            if (error)
                                return "amiibo." + error;
                        }
                    }
                 ...
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {clutch.amiibi.v1.GetAmiiboResponse} GetAmiiboResponse
                 */
                GetAmiiboResponse.fromObject = function fromObject(object) {
                    if (object instanceof $root.clutch.amiibi.v1.GetAmiiboResponse)
                        return object;
                    let message = new $root.clutch.amiibi.v1.GetAmiiboResponse();
                    if (object.amiibo) {
                        if (!Array.isArray(object.amiibo))
                            throw TypeError(".clutch.amiibi.v1.GetAmiiboResponse.amiibo: array expected");
                        message.amiibo = [];
                        for (let i = 0; i < object.amiibo.length; ++i) {
                            if (typeof object.amiibo[i] !== "object")
                                throw TypeError(".clutch.amiibi.v1.GetAmiiboResponse.amiibo: object expected");
                            message.amiibo[i] = $root.clutch.amiibi.v1.Amiibo.fromObject(object.amiibo[i]);
                        }
                    }
                    return message;
                };
                 ...
                 * @memberof clutch.amiibi.v1.GetAmiiboResponse
                 * @static
                 * @param {clutch.amiibi.v1.GetAmiiboResponse} message GetAmiiboResponse
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                GetAmiiboResponse.toObject = function toObject(message, options) {
                    ...
                    if (message.amiibo && message.amiibo.length) {
                        ...
                        for (let j = 0; j < message.amiibo.length; ++j)
                            object.amiibo[j] = $root.clutch.amiibi.v1.Amiibo.toObject(message.amiibo[j], options);
                    }
                    return object;
                };
            ...
            v1.Amiibo = (function() {
                 ...
                 * @property {string|null} [amiiboSerioes] Amiibo amiiboSerioes
                 * @property {string|null} [imageUrl] Amiibo imageUrl
                 * @property {clutch.amiibi.v1.Amiibo.Type|null} [type] Amiibo type
                 */
                 ...
                 * @implements IAmiibo
                 * @constructor
                 * @param {clutch.amiibi.v1.IAmiibo=} [properties] Properties to set
                 */
                 ...
                 * @memberof clutch.amiibi.v1.Amiibo
                 * @instance
                 */
                ...
                /**
                 * Amiibo amiiboSerioes.
                 * @member {string} amiiboSerioes
                 * @memberof clutch.amiibi.v1.Amiibo
                 * @instance
                 */
                Amiibo.prototype.amiiboSerioes = "";
                ...
                /**
                 * Amiibo type.
                 * @member {clutch.amiibi.v1.Amiibo.Type} type
                 * @memberof clutch.amiibi.v1.Amiibo
                 * @instance
                 */
                ...
                Amiibo.verify = function verify(message) {
                    ...
                    if (message.name != null && message.hasOwnProperty("name"))
                        if (!$util.isString(message.name))
                            return "name: string expected";
                    if (message.amiiboSerioes != null && message.hasOwnProperty("amiiboSerioes"))
                        if (!$util.isString(message.amiiboSerioes))
                            return "amiiboSerioes: string expected";
                 ...
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {clutch.amiibi.v1.Amiibo} Amiibo
                 */
                Amiibo.fromObject = function fromObject(object) {
                    if (object instanceof $root.clutch.amiibi.v1.Amiibo)
                        return object;
                    let message = new $root.clutch.amiibi.v1.Amiibo();
                    if (object.character != null)
                        message.character = String(object.character);
                    if (object.name != null)
                        message.name = String(object.name);
                    if (object.amiiboSerioes != null)
                        message.amiiboSerioes = String(object.amiiboSerioes);
                 ...
                 * @memberof clutch.amiibi.v1.Amiibo
                 * @static
                 * @param {clutch.amiibi.v1.Amiibo} message Amiibo
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Amiibo.toObject = function toObject(message, options) {
                    ...
                    if (message.name != null && message.hasOwnProperty("name"))
                        object.name = message.name;
                    if (message.amiiboSerioes != null && message.hasOwnProperty("amiiboSerioes"))
                        object.amiiboSerioes = message.amiiboSerioes;
                    if (message.imageUrl != null && message.hasOwnProperty("imageUrl"))
                        object.imageUrl = message.imageUrl;
                    if (message.type != null && message.hasOwnProperty("type"))
                        object.type = options.enums === String ? $root.clutch.amiibi.v1.Amiibo.Type[message.type] : message.type;
                    return object;
                };
                ...
                /**
                 * Type enum.
                 * @name clutch.amiibi.v1.Amiibo.Type
                 * @enum {string}
    ...
    pcn.echo = (function() {
        ...
        echo.v1 = (function() {
            ...
            v1.EchoAPI = (function() {
                ...
                /**
                 * Callback as used by {@link pcn.echo.v1.EchoAPI#sayHello}.
                 * @memberof pcn.echo.v1.EchoAPI
                 * @typedef SayHelloCallback
                 * @type {function}
                 * @param {Error|null} error Error, if any
                 * @param {pcn.echo.v1.SayHelloResponse} [response] SayHelloResponse
                 */
                 ...
                 * @memberof pcn.echo.v1.EchoAPI
                 * @instance
                 * @param {pcn.echo.v1.ISayHelloRequest} request SayHelloRequest message or plain object
                 * @param {pcn.echo.v1.EchoAPI.SayHelloCallback} callback Node-style callback called with the error, if any, and SayHelloResponse
                 * @returns {undefined}
                 * @variation 1
                 */
                Object.defineProperty(EchoAPI.prototype.sayHello = function sayHello(request, callback) {
                    return this.rpcCall(sayHello, $root.pcn.echo.v1.SayHelloRequest, $root.pcn.echo.v1.SayHelloResponse, request, callback);
                }, "name", { value: "SayHello" });
                 ...
                 * @instance
                 * @param {pcn.echo.v1.ISayHelloRequest} request SayHelloRequest message or plain object
                 * @returns {Promise<pcn.echo.v1.SayHelloResponse>} Promise
                 * @variation 2
                 */
            ...
            v1.SayHelloRequest = (function() {
                 ...
                 * @constructor
                 * @param {pcn.echo.v1.ISayHelloRequest=} [properties] Properties to set
                 */
                 ...
                 * @member {string} name
                 * @memberof pcn.echo.v1.SayHelloRequest
                 * @instance
                 */
                 ...
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {pcn.echo.v1.SayHelloRequest} SayHelloRequest
                 */
                SayHelloRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.pcn.echo.v1.SayHelloRequest)
                        return object;
                    let message = new $root.pcn.echo.v1.SayHelloRequest();
                    if (object.name != null)
                        message.name = String(object.name);
                    return message;
                };
                 ...
                 * @memberof pcn.echo.v1.SayHelloRequest
                 * @static
                 * @param {pcn.echo.v1.SayHelloRequest} message SayHelloRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            v1.SayHelloResponse = (function() {
                 ...
                 * @constructor
                 * @param {pcn.echo.v1.ISayHelloResponse=} [properties] Properties to set
                 */
                 ...
                 * @memberof pcn.echo.v1.SayHelloResponse
                 * @instance
                 */
                 ...
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {pcn.echo.v1.SayHelloResponse} SayHelloResponse
                 */
                SayHelloResponse.fromObject = function fromObject(object) {
                    if (object instanceof $root.pcn.echo.v1.SayHelloResponse)
                        return object;
                    let message = new $root.pcn.echo.v1.SayHelloResponse();
                    if (object.message != null)
                 ...
                 * @memberof pcn.echo.v1.SayHelloResponse
                 * @static
                 * @param {pcn.echo.v1.SayHelloResponse} message SayHelloResponse
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
